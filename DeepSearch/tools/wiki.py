...
from DeepSearch.base import ActionArguments, ActionCollection, ActionResponse
...
if __name__ == "__main__":
    ...
    # ✱ 1. вызов без await ─ функция синхронная
    resp = svc.mcp_search_wikipedia(
        query=("How many studio albums were published by Mercedes Sosa "
               "between 2000 and 2009 (included)? You can use the latest "
